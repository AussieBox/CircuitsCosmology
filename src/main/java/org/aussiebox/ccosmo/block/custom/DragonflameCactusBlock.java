...
public class DragonflameCactusBlock extends Block {
    ...
    private static final VoxelShape OUTLINE_SHAPE = Block.createCuboidShape(1.0F, 0.0F, 1.0F, 15.0F, 16.0F, 15.0F);
    private static final VoxelShape COLLISION_SHAPE = Block.createCuboidShape(1.0F, 0.0F, 1.0F, 15.0F, 15.0F, 15.0F);
    ...
    public DragonflameCactusBlock(Settings settings) {
        super(settings);
    ...
    protected void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        if (world instanceof ServerWorld serverWorld) {
            if (entity instanceof ItemEntity itemEntity) {
                if (itemEntity.getStack().isIn(TagKey.of(RegistryKeys.ITEM, Identifier.of(CCOSMO.MOD_ID, "dragonflame_cactus_destroys")))) {

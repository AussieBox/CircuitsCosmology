package org.aussiebox.ccosmo.block;
...
public class ModBlocks {
    ...
    private static RegistryKey<Block> keyOfBlock(String name) {
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(CCOSMO.MOD_ID, name));
    }

    private static RegistryKey<Item> keyOfItem(String name) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(CCOSMO.MOD_ID, name));
    }

    public static void init() {
        CCOSMO.LOGGER.info("Registering Blocks for " + CCOSMO.MOD_ID);
    }
}

...
public interface BOBConstants {
    ...
    RegistryKey<DamageType> SHIMMERFORK_DAMAGE = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, BOB.id("shimmerfork"));
    ...
    SoundEvent SHIMMER_TOOL_CHARGE_SOUND = SoundEvent.of(BOB.id("item.shimmer_tool.charge"));
    SoundEvent SHIMMERSEEP_CHARGE_SOUND = SoundEvent.of(BOB.id("item.shimmer_tool.shimmerseep_charge"));
